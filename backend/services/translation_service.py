...
- **Estructura gramatical nativa (SOV vs SVO)**: Respeta que el quechua y el aimara son lenguas con estructura sintáctica SOV (Sujeto-Objeto-Verbo), mientras que el español es SVO (Sujeto-Verbo-Objeto). Adapta el orden de la oración en el idioma destino para que suene natural, correcta y fluida.
...
6. **Estructura gramatical nativa (SOV vs SVO)**: Respeta que el quechua y el aimara son lenguas con estructura sintáctica SOV (Sujeto-Objeto-Verbo), mientras que el español es SVO (Sujeto-Verbo-Objeto). Adapta el orden de la oración en el idioma destino para que suene natural, correcta y fluida.
7. Aplica correctamente la gramática, morfología y el uso de sufijos nativos (quechua y aimara).
8. Devuelve ÚNICAMENTE el texto traducido limpio, sin ningún carácter adicional, sin asteriscos, sin pasos intermedios y sin explicaciones."""
